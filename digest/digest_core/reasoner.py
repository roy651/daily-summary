...
_REASONER_SYSTEM = (
    ...
    "blocker it's waiting on; the handed-back work itself is the active action.\n"
    "- BREVITY: keep each digest_update detail to 1-2 tight sentences — lead with what changed and the "
    "needed action; don't recap the whole thread.\n"
    ...
    "contradicting note. ALSO CONSOLIDATE: if several knowledge notes state the SAME fact (paraphrases), "
    "retract the redundant ones (keep one clear note) — don't let duplicates accumulate.\n"
    ...
    "business inquiry — but do NOT surface obvious cold-sales / mass-outreach spam as a lead (drop it); "
